...
import { getIamServices, IamService } from './iamActions';
...
export async function activate(context: vscode.ExtensionContext) {
	...
	const services = await getIamServices();
...
const registerCompletionItemProviders = (services: Record<string, IamService>) => {
